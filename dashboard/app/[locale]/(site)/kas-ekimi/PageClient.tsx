...
export default function KasEkimiPage() {
  const t = useTranslations("pages.brow");
  ...
  return (
    <section className="pt-28">
      ...
      <div className="py-20 px-6 max-w-4xl mx-auto">
        ...
        <p className="text-on-surface/70 text-lg leading-relaxed max-w-2xl mb-8" dangerouslySetInnerHTML={{ __html: t.raw("hero.lede") }} />
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        <span className="text-primary font-label text-[11px] tracking-[0.3em] uppercase block mb-4">{t("angle.eyebrow")}</span>
        <h2 className="font-headline text-3xl mb-6">{t("angle.title")}</h2>
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            <p className="text-on-surface/75 text-sm leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: t.raw("angle.p1") }} />
            <p className="text-on-surface/75 text-sm leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: t.raw("angle.p2") }} />
            <p className="text-on-surface/75 text-sm leading-relaxed">{t("angle.p3")}</p>
          </div>
          <div className="bg-surface-container-high p-6 rounded-sm">
            <h3 className="font-headline text-lg mb-4 text-primary">{t("angle.compareTitle")}</h3>
            <div className="space-y-4 text-sm">
              <div className="flex items-center gap-4">
                <span className="material-symbols-outlined text-primary text-[18px]">horizontal_rule</span>
                <div>
                  <p className="text-on-surface">{t("angle.row1Title")}</p>
                  <p className="text-[11px] text-on-surface/60">{t("angle.row1Sub")}</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="material-symbols-outlined text-on-surface/50 text-[18px]">arrow_outward</span>
                <div>
                  <p className="text-on-surface">{t("angle.row2Title")}</p>
                  <p className="text-[11px] text-on-surface/60">{t("angle.row2Sub")}</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <span className="material-symbols-outlined text-on-surface/50 text-[18px]">north</span>
                <div>
                  <p className="text-on-surface">{t("angle.row3Title")}</p>
                  <p className="text-[11px] text-on-surface/60">{t("angle.row3Sub")}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 px-6 bg-surface-container-low">
        <div className="max-w-3xl mx-auto">
          <div className="bg-primary/5 border-l-2 border-primary rounded-sm p-8">
            <h2 className="font-headline text-xl mb-4 text-primary">{t("trim.title")}</h2>
            <p className="text-on-surface/90 leading-relaxed text-sm" dangerouslySetInnerHTML={{ __html: t.raw("trim.body") }} />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto">
        ...
        <div className="bg-surface-container-high p-8 rounded-sm">
          <div className="flex justify-between items-start mb-4">
            ...
            <Link href="/vaka/kas-restorasyonu-400-greft" className="text-primary text-sm uppercase tracking-wider hover:underline whitespace-nowrap">{t("case.linkText")}</Link>
          </div>
        </div>
